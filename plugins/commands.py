...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        ...
        if not await db.get_chat(message.chat.id):
            ...
            await client.send_message(LOG_CHANNEL, script.LOG_TEXT_G.format(message.chat.title, message.chat.id, total, "Abhi"))       
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        await client.send_photo(
            ...
            caption="**Please Join Our Backup Channel First...\n\nAfter That, Click On The '🔄 Try Again' Button ...\n\nThen You Will Get The Movie File...**",
